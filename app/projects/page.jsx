...
const projects = [
  ...
  },
  {
    ...
    title: "project 5",
    description:
      "A web app used to store the credentials and passwords with local storage. The app is build using CRUD functionality, using react framework and hosted on Vercel.",
